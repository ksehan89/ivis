...
namespace E01HelloWorldExtensions {
    template <template <typename > class _ExtensionType>
    class XAttributeExtension {
     public:
        typedef _ExtensionType< E01HelloWorldProxyBase::XAttribute> extension_type;
    
        static_assert(std::is_base_of<typename CommonAPI::AttributeExtension< E01HelloWorldProxyBase::XAttribute>, extension_type>::value,
                      "Not CommonAPI Attribute Extension!");
    
        XAttributeExtension(E01HelloWorldProxyBase& proxy): attributeExtension_(proxy.getXAttribute()) {
        }
...
struct DefaultAttributeProxyHelper< ::v0::commonapi::examples::E01HelloWorldProxy,
    _AttributeExtension> {
    typedef typename ::v0::commonapi::examples::E01HelloWorldProxy<
            ::v0::commonapi::examples::E01HelloWorldExtensions::XAttributeExtension<_AttributeExtension>
    > class_t;
};
}
